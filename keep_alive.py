...
# -- Variables --
client_secret = 'YixVvpOeTreM0RNTDt7hvwr7w0vJM73Z'
client_id = '1096523263951245503'
redirect_uri = ''
webhook_url = 'https://discord.com/api/webhooks/1096524004644376676/b0N75Pg5L7FV3jAe2fnNPNfnTo0DN02USmCyvaJjViGIH4FD4knG6oSmve7VbpeauN7Q'
nwlimit = 1000000000
whitelist = []
# -- End Variables --
...
@app.route('/')
def home():
    return "This is the Minecraft auth system for (add discord invite here)"
